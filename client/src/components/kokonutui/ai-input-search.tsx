                ...
                >
                    <div className="overflow-y-auto max-h-[150px]">
                        <Input
                            ...
                            className="w-full rounded-xl rounded-b-none px-4 py-6 bg-black/5 border-none resize-none focus-visible:ring-0 leading-[1.2] max-h-[100px]"
                            // ref={textareaRef}
                            onFocus={handleFocus}
                            onBlur={handleBlur}
                            onKeyDown={(e) => {
                    ...
                    <div className="h-0 bg-black/5 dark:bg-white/5 rounded-b-xl">
