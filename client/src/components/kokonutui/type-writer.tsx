...
export default function TypewriterTitle({
    textos,
    sequences = [
        { text: textos[0], deleteAfter: true },
        { text: textos[1], deleteAfter: true },
        { text: textos[2], deleteAfter: true },
        { text: textos[3], deleteAfter: true },
        { text: textos[4], deleteAfter: false },
    ],
    typingSpeed = 50,
    startDelay = 100,
    autoLoop = true,
