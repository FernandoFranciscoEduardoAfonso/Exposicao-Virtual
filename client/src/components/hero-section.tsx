...
import FeaturedBanners from '@/sections/site/components/FeaturedBanners'
                    ...
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div>
                                    <SectionTitle textoNormal="Obras" textoDestaque='Patrocionadas' posicaoDestaque='right' />
                                ...
                                <div className="h-[auto] p-4 inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl shadow-lg shadow-zinc-950/15 ring-1">
                                    ...
                                    {/* <FeaturedTitle text='Obras Patrocionadas' /> */}
