...
const CardObra = ({ direction }: { direction: "vertical" | "horizontal" }) => {
      ...
      <div className="px-1 w-full">
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm font-medium">Fotografia</p>
          </div>
          <Dropdown
            alignContent="end"
            direccion="vertical"
        ...
        <div className="flex justify-between items-center mt-2">
          <p className="text-muted-foreground text-sm">5M visualizações</p>
